    ...
    val achievements =
        listOf(
            ...
            Achievement(
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "tomato" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                id = "lib_broccoli_pro",
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "broccoli" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "bell_pepper" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                id = "lib_garlic_pro",
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "garlic" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "purple_onion" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                id = "lib_squash_pro",
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "squash" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                id = "lib_apple_pro",
            ...
            Achievement(
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "plagues" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                id = "lib_farmers_pro",
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "farmers" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "pesticides" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
            Achievement(
                id = "lib_genetic_pro",
                ...
                checkEarned = {
                        provider ->
                    provider.libraryCategories.find { it.id == "genetic" }?.entries?.all { it.isUnlocked } ?: false
                },
            ),
